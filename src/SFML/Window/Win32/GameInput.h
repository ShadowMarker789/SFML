...
#define GAMEINPUT_INVALID_CALLBACK_TOKEN_VALUE 0x0000000000000000ULL
    ...
    typedef void(CALLBACK* GameInputReadingCallback)(_In_ GameInputCallbackToken callbackToken,
                                                     _In_ void*                  context,
    ...
    typedef void(CALLBACK* GameInputKeyboardLayoutCallback)(
        ...
        _In_ IGameInputDevice*       device,
        _In_ uint64_t                timestamp,
        _In_ GameInputKeyboardLayout currentLayout,
        _In_ GameInputKeyboardLayout previousLayout);
...
#define INTERFACE IGameInput
    ...
    {
        _Must_inspect_result_ IFACEMETHOD(QueryInterface)(THIS_ _In_ REFIID riid, _COM_Outptr_ void** ppvObj) PURE;
        ...
        _Must_inspect_result_ IFACEMETHOD(GetCurrentReading)(THIS_ _In_ GameInputKind inputKind,
                                                             _In_opt_                 IGameInputDevice * device,
                                                             _COM_Outptr_ IGameInputReading * *reading) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            GetNextReading)(THIS_ _In_         IGameInputReading * referenceReading,
                            _In_ GameInputKind inputKind,
                            _In_opt_           IGameInputDevice * device,
                            _COM_Outptr_       IGameInputReading * *reading) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            GetPreviousReading)(THIS_ _In_         IGameInputReading * referenceReading,
                                _In_ GameInputKind inputKind,
                                _In_opt_           IGameInputDevice * device,
                                _COM_Outptr_       IGameInputReading * *reading) PURE;

        _Must_inspect_result_ IFACEMETHOD(GetTemporalReading)(THIS_ _In_ uint64_t timestamp,
                                                              _In_                IGameInputDevice * device,
                                                              _COM_Outptr_        IGameInputReading * *reading) PURE;

        IFACEMETHOD(RegisterReadingCallback)
        (THIS_ _In_opt_                                           IGameInputDevice * device,
         _In_ GameInputKind                                       inputKind,
        ...
        IFACEMETHOD(RegisterGuideButtonCallback)
        (THIS_ _In_opt_                                           IGameInputDevice * device,
         _In_opt_ void*                                           context,
        ...
        IFACEMETHOD_(void, StopCallback)(THIS_ _In_ GameInputCallbackToken callbackToken) PURE;

        IFACEMETHOD_(bool, UnregisterCallback)
        (THIS_ _In_ GameInputCallbackToken callbackToken, _In_ uint64_t timeoutInMicroseconds) PURE;

        _Must_inspect_result_ IFACEMETHOD(CreateDispatcher)(THIS_ _COM_Outptr_ IGameInputDispatcher * *dispatcher) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            CreateAggregateDevice)(THIS_ _In_ GameInputKind inputKind, _COM_Outptr_ IGameInputDevice * *device) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            FindDeviceFromId)(THIS_ _In_ APP_LOCAL_DEVICE_ID const* value, _COM_Outptr_ IGameInputDevice** device) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            FindDeviceFromObject)(THIS_ _In_ IUnknown * value, _COM_Outptr_ IGameInputDevice * *device) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            FindDeviceFromPlatformHandle)(THIS_ _In_ HANDLE value, _COM_Outptr_ IGameInputDevice * *device) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            FindDeviceFromPlatformString)(THIS_ _In_ LPCWSTR value, _COM_Outptr_ IGameInputDevice * *device) PURE;

        IFACEMETHOD(EnableOemDeviceSupport)
        (THIS_ _In_ uint16_t vendorId, _In_ uint16_t productId, _In_ uint8_t interfaceNumber, _In_ uint8_t collectionNumber)
            PURE;

        IFACEMETHOD_(void, SetFocusPolicy)(THIS_ _In_ GameInputFocusPolicy policy) PURE;
    };
...
#define INTERFACE IGameInputReading
    DECLARE_INTERFACE_IID_(INTERFACE, IUnknown, "2156947A-E1FA-4DE0-A30B-D812931DBD8D")
    {
        ...
        IFACEMETHOD_(uint64_t, GetSequenceNumber)(THIS_ _In_ GameInputKind inputKind) PURE;

        IFACEMETHOD_(uint64_t, GetTimestamp)(THIS) PURE;

        IFACEMETHOD_(void, GetDevice)(THIS_ _Outptr_ IGameInputDevice * *device) PURE;

        IFACEMETHOD_(bool, GetRawReport)(THIS_ _Outptr_result_maybenull_ IGameInputRawDeviceReport * *report) PURE;

        IFACEMETHOD_(uint32_t, GetControllerAxisCount)(THIS) PURE;

        IFACEMETHOD_(uint32_t, GetControllerAxisState)
        (THIS_ _In_ uint32_t stateArrayCount, _Out_writes_(stateArrayCount) float* stateArray) PURE;

        IFACEMETHOD_(uint32_t, GetControllerButtonCount)(THIS) PURE;

        IFACEMETHOD_(uint32_t, GetControllerButtonState)
        (THIS_ _In_ uint32_t stateArrayCount, _Out_writes_(stateArrayCount) bool* stateArray) PURE;

        IFACEMETHOD_(uint32_t, GetControllerSwitchCount)(THIS) PURE;

        IFACEMETHOD_(uint32_t, GetControllerSwitchState)
        (THIS_ _In_ uint32_t stateArrayCount, _Out_writes_(stateArrayCount) GameInputSwitchPosition * stateArray) PURE;

        IFACEMETHOD_(uint32_t, GetKeyCount)(THIS) PURE;

        IFACEMETHOD_(uint32_t, GetKeyState)
        (THIS_ _In_ uint32_t stateArrayCount, _Out_writes_(stateArrayCount) GameInputKeyState * stateArray) PURE;

        IFACEMETHOD_(bool, GetMouseState)(THIS_ _Out_ GameInputMouseState * state) PURE;

        IFACEMETHOD_(uint32_t, GetTouchCount)(THIS) PURE;

        IFACEMETHOD_(uint32_t, GetTouchState)
        (THIS_ _In_ uint32_t stateArrayCount, _Out_writes_(stateArrayCount) GameInputTouchState * stateArray) PURE;

        IFACEMETHOD_(bool, GetMotionState)(THIS_ _Out_ GameInputMotionState * state) PURE;

        IFACEMETHOD_(bool, GetArcadeStickState)(THIS_ _Out_ GameInputArcadeStickState * state) PURE;

        IFACEMETHOD_(bool, GetFlightStickState)(THIS_ _Out_ GameInputFlightStickState * state) PURE;

        IFACEMETHOD_(bool, GetGamepadState)(THIS_ _Out_ GameInputGamepadState * state) PURE;

        IFACEMETHOD_(bool, GetRacingWheelState)(THIS_ _Out_ GameInputRacingWheelState * state) PURE;

        IFACEMETHOD_(bool, GetUiNavigationState)(THIS_ _Out_ GameInputUiNavigationState * state) PURE;
    };
...
#define INTERFACE IGameInputDevice
    DECLARE_INTERFACE_IID_(INTERFACE, IUnknown, "31DD86FB-4C1B-408A-868F-439B3CD47125")
    {
        ...
        IFACEMETHOD_(void, GetBatteryState)(THIS_ _Out_ GameInputBatteryState * state) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            CreateForceFeedbackEffect)(THIS_ _In_ uint32_t                          motorIndex,
                                       _In_ GameInputForceFeedbackParams const*     params,
                                       _COM_Outptr_ IGameInputForceFeedbackEffect** effect) PURE;

        IFACEMETHOD_(bool, IsForceFeedbackMotorPoweredOn)(THIS_ _In_ uint32_t motorIndex) PURE;

        IFACEMETHOD_(void, SetForceFeedbackMotorGain)(THIS_ _In_ uint32_t motorIndex, _In_ float masterGain) PURE;

        IFACEMETHOD(SetHapticMotorState)
        (THIS_ _In_ uint32_t motorIndex, _In_opt_ GameInputHapticFeedbackParams const* params) PURE;

        IFACEMETHOD_(void, SetRumbleState)(THIS_ _In_opt_ GameInputRumbleParams const* params) PURE;

        IFACEMETHOD_(void, SetInputSynchronizationState)(THIS_ _In_ bool enabled) PURE;

        IFACEMETHOD_(void, SendInputSynchronizationHint)(THIS) PURE;

        IFACEMETHOD_(void, PowerOff)(THIS) PURE;

        _Must_inspect_result_ IFACEMETHOD(CreateRawDeviceReport)(THIS_ _In_ uint32_t               reportId,
                                                                 _In_ GameInputRawDeviceReportKind reportKind,
                                                                 _COM_Outptr_ IGameInputRawDeviceReport * *report) PURE;

        _Must_inspect_result_ IFACEMETHOD(
            GetRawDeviceFeature)(THIS_ _In_ uint32_t reportId, _COM_Outptr_ IGameInputRawDeviceReport * *report) PURE;

        IFACEMETHOD(SetRawDeviceFeature)(THIS_ _In_ IGameInputRawDeviceReport * report) PURE;

        IFACEMETHOD(SendRawDeviceOutput)(THIS_ _In_ IGameInputRawDeviceReport * report) PURE;

        IFACEMETHOD(ExecuteRawDeviceIoControl)
        (THIS_ _In_ uint32_t                                controlCode,
        ...
        IFACEMETHOD_(bool, AcquireExclusiveRawDeviceAccess)(THIS_ _In_ uint64_t timeoutInMicroseconds) PURE;
...
#define INTERFACE IGameInputDispatcher
    DECLARE_INTERFACE_IID_(INTERFACE, IUnknown, "415EED2E-98CB-42C2-8F28-B94601074E31")
    {
        ...
        IFACEMETHOD_(bool, Dispatch)(THIS_ _In_ uint64_t quotaInMicroseconds) PURE;

        IFACEMETHOD(OpenWaitHandle)(THIS_ _Outptr_result_nullonfailure_ HANDLE * waitHandle) PURE;
    };
...
#define INTERFACE IGameInputForceFeedbackEffect
    DECLARE_INTERFACE_IID_(INTERFACE, IUnknown, "51BDA05E-F742-45D9-B085-9444AE48381D")
    {
        ...
        IFACEMETHOD_(void, SetGain)(THIS_ _In_ float gain) PURE;

        IFACEMETHOD_(void, GetParams)(THIS_ _Out_ GameInputForceFeedbackParams * params) PURE;

        IFACEMETHOD_(bool, SetParams)(THIS_ _In_ GameInputForceFeedbackParams const* params) PURE;

        IFACEMETHOD_(GameInputFeedbackEffectState, GetState)(THIS) PURE;

        IFACEMETHOD_(void, SetState)(THIS_ _In_ GameInputFeedbackEffectState state) PURE;
    };
...
#define INTERFACE IGameInputRawDeviceReport
    DECLARE_INTERFACE_IID_(INTERFACE, IUnknown, "61F08CF1-1FFC-40CA-A2B8-E1AB8BC5B6DC")
    {
        ...
        IFACEMETHOD_(size_t, GetRawData)(THIS_ _In_ size_t bufferSize, _Out_writes_(bufferSize) void* buffer) PURE;

        IFACEMETHOD_(bool, SetRawData)(THIS_ _In_ size_t bufferSize, _In_reads_(bufferSize) void const* buffer) PURE;

        IFACEMETHOD_(bool, GetItemValue)(THIS_ _In_ uint32_t itemIndex, _Out_ int64_t * value) PURE;

        IFACEMETHOD_(bool, SetItemValue)(THIS_ _In_ uint32_t itemIndex, _In_ int64_t value) PURE;

        IFACEMETHOD_(bool, ResetItemValue)(THIS_ _In_ uint32_t itemIndex) PURE;
...
#undef INTERFACE
    ...
    _Must_inspect_result_ STDAPI GameInputCreate(_COM_Outptr_ IGameInput** gameInput);
...
#define IGameInput_GetCurrentReading(This, inputKind, device, reading) \
    ((This)->lpVtbl->GetCurrentReading(This, inputKind, device, reading))
#define IGameInput_GetNextReading(This, referenceReading, inputKind, device, reading) \
    ((This)->lpVtbl->GetNextReading(This, referenceReading, inputKind, device, reading))
#define IGameInput_GetPreviousReading(This, referenceReading, inputKind, device, reading) \
    ((This)->lpVtbl->GetPreviousReading(This, referenceReading, inputKind, device, reading))
#define IGameInput_GetTemporalReading(This, timestamp, device, reading) \
    ((This)->lpVtbl->GetTemporalReading(This, timestamp, device, reading))
#define IGameInput_RegisterReadingCallback(This, device, inputKind, analogThreshold, context, callbackFunc, callbackToken) \
    ((This)->lpVtbl->RegisterReadingCallback(This, device, inputKind, analogThreshold, context, callbackFunc, callbackToken))
#define IGameInput_RegisterDeviceCallback(This, device, inputKind, statusFilter, enumerationKind, context, callbackFunc, callbackToken) \
    ((This)->lpVtbl->RegisterDeviceCallback(This, device, inputKind, statusFilter, enumerationKind, context, callbackFunc, callbackToken))
#define IGameInput_RegisterGuideButtonCallback(This, device, context, callbackFunc, callbackToken) \
    ((This)->lpVtbl->RegisterGuideButtonCallback(This, device, context, callbackFunc, callbackToken))
#define IGameInput_RegisterKeyboardLayoutCallback(This, device, context, callbackFunc, callbackToken) \
    ((This)->lpVtbl->RegisterKeyboardLayoutCallback(This, device, context, callbackFunc, callbackToken))
#define IGameInput_StopCallback(This, callbackToken) ((This)->lpVtbl->StopCallback(This, callbackToken))
#define IGameInput_UnregisterCallback(This, callbackToken, timeoutInMicroseconds) \
    ((This)->lpVtbl->UnregisterCallback(This, callbackToken, timeoutInMicroseconds))
#define IGameInput_CreateDispatcher(This, dispatcher) ((This)->lpVtbl->CreateDispatcher(This, dispatcher))
#define IGameInput_CreateAggregateDevice(This, inputKind, device) \
    ((This)->lpVtbl->CreateAggregateDevice(This, inputKind, device))
...
#define IGameInput_FindDeviceFromPlatformHandle(This, value, device) \
    ((This)->lpVtbl->FindDeviceFromPlatformHandle(This, value, device))
#define IGameInput_FindDeviceFromPlatformString(This, value, device) \
    ((This)->lpVtbl->FindDeviceFromPlatformString(This, value, device))
#define IGameInput_EnableOemDeviceSupport(This, vendorId, productId, interfaceNumber, collectionNumber) \
    ((This)->lpVtbl->EnableOemDeviceSupport(This, vendorId, productId, interfaceNumber, collectionNumber))
...
#define IGameInputReading_GetControllerAxisState(This, stateArrayCount, stateArray) \
    ((This)->lpVtbl->GetControllerAxisState(This, stateArrayCount, stateArray))
#define IGameInputReading_GetControllerButtonCount(This) ((This)->lpVtbl->GetControllerButtonCount(This))
#define IGameInputReading_GetControllerButtonState(This, stateArrayCount, stateArray) \
    ((This)->lpVtbl->GetControllerButtonState(This, stateArrayCount, stateArray))
#define IGameInputReading_GetControllerSwitchCount(This) ((This)->lpVtbl->GetControllerSwitchCount(This))
#define IGameInputReading_GetControllerSwitchState(This, stateArrayCount, stateArray) \
    ((This)->lpVtbl->GetControllerSwitchState(This, stateArrayCount, stateArray))
#define IGameInputReading_GetKeyCount(This) ((This)->lpVtbl->GetKeyCount(This))
#define IGameInputReading_GetKeyState(This, stateArrayCount, stateArray) \
    ((This)->lpVtbl->GetKeyState(This, stateArrayCount, stateArray))
...
#define IGameInputReading_GetTouchState(This, stateArrayCount, stateArray) \
    ((This)->lpVtbl->GetTouchState(This, stateArrayCount, stateArray))
...
#define IGameInputDevice_CreateForceFeedbackEffect(This, motorIndex, params, effect) \
    ((This)->lpVtbl->CreateForceFeedbackEffect(This, motorIndex, params, effect))
#define IGameInputDevice_IsForceFeedbackMotorPoweredOn(This, motorIndex) \
    ((This)->lpVtbl->IsForceFeedbackMotorPoweredOn(This, motorIndex))
#define IGameInputDevice_SetForceFeedbackMotorGain(This, motorIndex, masterGain) \
    ((This)->lpVtbl->SetForceFeedbackMotorGain(This, motorIndex, masterGain))
#define IGameInputDevice_SetHapticMotorState(This, motorIndex, params) \
    ((This)->lpVtbl->SetHapticMotorState(This, motorIndex, params))
#define IGameInputDevice_SetRumbleState(This, params) ((This)->lpVtbl->SetRumbleState(This, params))
#define IGameInputDevice_SetInputSynchronizationState(This, enabled) \
...
#define IGameInputDevice_CreateRawDeviceReport(This, reportId, reportKind, report) \
    ((This)->lpVtbl->CreateRawDeviceReport(This, reportId, reportKind, report))
#define IGameInputDevice_GetRawDeviceFeature(This, reportId, report) \
    ((This)->lpVtbl->GetRawDeviceFeature(This, reportId, report))
...
#define IGameInputDevice_ExecuteRawDeviceIoControl(This, controlCode, inputBufferSize, inputBuffer, outputBufferSize, outputBuffer, outputSize) \
    ((This)->lpVtbl->ExecuteRawDeviceIoControl(This, controlCode, inputBufferSize, inputBuffer, outputBufferSize, outputBuffer, outputSize))
#define IGameInputDevice_AcquireExclusiveRawDeviceAccess(This, timeoutInMicroseconds) \
    ((This)->lpVtbl->AcquireExclusiveRawDeviceAccess(This, timeoutInMicroseconds))
