...
private:
    ...
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] static LRESULT win32JoystickWndProc(HWND hwnd, std::uint32_t msg, WPARAM wParam, LPARAM lParam);

    ////////////////////////////////////////////////////////////
    /// \brief TODO
    ///
    ////////////////////////////////////////////////////////////
    [[nodiscard]] static DWORD WINAPI win32JoystickDispatchThread(LPVOID lpParam);
